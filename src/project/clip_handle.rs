...
use crate::project::clip::GainPoint;
...
pub struct ClipHandle {
    ...
    pub fade_in_frames: AtomicU64,
    pub fade_out_frames: AtomicU64,
    pub stretch_ratio: Arc<AtomicU32>,
...
impl ClipHandle {
    pub fn new(clip_id: Uuid, audio_data: Vec<f32>, channels: u16, sample_rate: u32) -> Self {
        ...
        Self {
            ...
            fade_in_frames: AtomicU64::new(0),
            fade_out_frames: AtomicU64::new(0),
            stretch_ratio: Arc::new(AtomicU32::new(f32::to_bits(1.0))),
